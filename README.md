...
| 번호 | 질문                                                                                                    | 상태                      |
| ---- | ------------------------------------------------------------------------------------------------------- | ------------------------- |
| 1    | 이벤트 위임이란 무엇이며, JavaScript에서 어떻게 작동하는지 설명해주시겠어요?                            | 2024-1-1 (월) 작성완료 ✅ |
| 2    | 프로토타입 상속은 어떻게 작동하나요?                                                                    | 2024-1-1 (월) 작성완료 ✅ |
| 3    | null, undefined, undeclared 변수의 차이는 무엇이며, 각 상태를 확인하는 방법은 무엇인가요?               | 2024-1-1 (월) 작성완료 ✅ |
